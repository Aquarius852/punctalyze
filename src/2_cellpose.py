...
if __name__ == '__main__':
    ...
    puncta_blur = [
        ...
        for img in imgs_cp
    ] #use if youre trying to do cytoplasmic marker from a puncta only channel - will blur the puncta first a567nd expand it 

    # ---------------- apply cellpose ----------------
    masks, flows, styles = apply_cellpose(puncta_blur, niter=2000, diameter=300, big_images=True)
